...
Essential to understanding how to solve a problem. In order to be able to
solve a problem, you have to at least understand what the problem is and what
it is asking. Take some time to allow the problem to load into your brain.
Don't rush this.
...
Check for Implicit Requirements. Are there requirements that are not
explicitly stated?
...
Some questions to ask the interviewer (or perhaps yourself) to better
understand the problem.
...
As a rule of thumb, you can keep the number of mental models to one if it
fully, and accurately, captures the requirements of the problem.
...
the problem, and confirm that you are working in the right direction.
...
solve problems, it would be a good idea to consistently create mental models
to assist you.
...
* The challenge is to get to the right amount of detail (think about the
steps to creating a peanut butter and jelly sandwich.)
