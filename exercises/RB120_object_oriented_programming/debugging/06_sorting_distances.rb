...
# Further Exploration
puts Length.new(10, :km).as_nautical_miles.as_kilometers == Length.new(10, :km)
# => false

puts(Length.new(10, :km).as_nautical_miles.as_kilometers - Length.new(10, :km)).abs < 0.001
# => true
