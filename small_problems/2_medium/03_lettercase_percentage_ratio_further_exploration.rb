...
def letter_percentages(string)
  ...
  percentages[:lowercase] = ((number_lowercase * 100.0) / string.size).round(2)
  percentages[:uppercase] = ((number_uppercase * 100.0) / string.size).round(2)
  percentages[:neither] = ((number_neither * 100.0) / string.size).round(2)
